...
<style>
    ...
    .category-side-card .example-list p + p {
        margin-top: 6px;
    }
    ...
    <div class="category-form-layout">
        <div class="category-main-card">
            <div class="category-main-header">
                ...
                <p>Isi data berikut untuk membuat kategori koleksi buku perpustakaan.</p>
            </div>
        ...
        <div class="category-side">
            <div class="category-side-card">
                ...
                <div class="example-list">
                    <p><strong>Nama:</strong> Teknologi</p>
                    <p><strong>Deskripsi:</strong> Buku pemrograman, jaringan, dan sistem informasi.</p>
                </div>
            </div>
            ...
            <div class="category-side-card category-tips">
                <h3>Tips Penamaan</h3>
                <ul>
                    <li>Gunakan nama singkat dan jelas.</li>
                    <li>Hindari nama kategori yang terlalu mirip.</li>
                    <li>Sesuaikan dengan jenis koleksi buku.</li>
                </ul>
            </div>
        </div>
    </div>
