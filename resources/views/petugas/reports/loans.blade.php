...
<div class="report-page">
    <div class="report-wrap">
        <div class="hero">
            ...
            <p style="opacity: .9;">Ringkasan statistik peminjaman untuk pemantauan operasional petugas.</p>
            <div style="margin-top: 14px;">
                <a href="{{ route('petugas.reports.export') }}" style="display:inline-flex; align-items:center; gap:8px; text-decoration:none; color:#fff; border:1px solid rgba(255,255,255,.5); padding:8px 12px; border-radius:8px; font-weight:700;">
            ...
            <div class="section-head">
                ...
                <div class="toolbar">
                    @foreach([7, 30, 90, 365] as $period)
                        <a href="{{ route('petugas.reports.loans', ['days' => $period]) }}" class="{{ $days === $period ? 'active' : '' }}">{{ $period }} hari</a>
                    @endforeach
                </div>
            </div>
        </div>
